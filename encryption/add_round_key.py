"""
AES AddRoundKey
Stage 2: XOR the state matrix with the round key

This is the simplest operation in AES, but also the only step that uses the key
"""
...
def add_round_key(state, round_key):
    ...
    State and RoundKey are both 4x4 byte matrices
    Corresponding bytes are XORed together
